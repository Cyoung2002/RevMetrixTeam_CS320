...
<body>
    ...
    <div class="wrapper">
        ...
        <c:if test="${! empty successMessage}">
            <div class="success">Successfully added Game: <span class="success_title">${successMessage}</span></div>
        </c:if>
        ...
        <form action="${pageContext.servletContext.contextPath}/insertGame" method="post">
            ...
            <table>
				...
				<tr>
                    ...
                    <td><input type="text" name="season" size="20" value="${season}" /></td>
                </tr>
				<tr>
				...
				<tr>
                    ...
                    <td><input type="text" name="game" size="20" value="${game}" /></td>
                </tr>
				<tr>
                    <td class="label">Lane:</td>
                    <td><input type="text" name="lane" size="20" value="${lane}" /></td>
                </tr>		
						
            </table>

            <input type="submit" name="submitinsertgame" value="Add Game">
        </form>
